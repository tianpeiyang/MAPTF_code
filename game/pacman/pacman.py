...
"""
from game.pacman.game import GameStateData
from game.pacman.game import Game
from game.pacman.game import Directions
from game.pacman.game import Actions
from game.pacman.util import nearestPoint
from game.pacman.util import manhattanDistance
import util
...
import game.pacman.pacmanDQN_Agents
import game.pacman.ghostAgents
...
def loadAgent(pacman, nographics):
    ...
    # pythonPathDirs.append('./game/Pacman/PacmanDQN')
    # pythonPathDirs.append('./game/Pacman/keyboardAgents')
    # pythonPathDirs.append('./game/Pacman/ghostAgents')
    ...
    #         try:
    #             module = __import__('game.Pacman.' + modulename[:-3])
    #             print('import : {}'.format('game.Pacman.' + modulename[:-3]))
    #         except ImportError:
    #             print('can\'t import :{}'.format('game.Pacman.' + modulename[:-3]))
    #             continue
    #         print(modulename, pacman, dir(module))
    #         if pacman in dir(module.Pacman):
    ...
    if pacman == "PacmanDQN":
        return PacmanDQN
    elif pacman == "GhostAgent":
        return GhostAgent
    elif pacman == "RandomGhost":
        return RandomGhost
    elif pacman == "DirectionalGhost":
        return DirectionalGhost
    elif pacman == "KeyboardAgent":
        return KeyboardAgent
    elif pacman == "KeyboardAgent2":
        return KeyboardAgent2
    else:
        assert False, pacman + ' bad agent type'


def replayGame(layout, actions, display):
    import game.pacman.pacmanAgents as pacmanAgents
    import game.pacman.ghostAgents as ghostAgents
