...
from game.pacman.game import Grid
import os
import random
...
class Layout:
    ...
    def processLayoutText(self, layoutText):
        ...
        # (x1, y1) = self.getRandomLegalPosition()
        # self.agentPositions.append((0, (x1, y1)))
        # for i in range(self.numGhosts):
        #     (x1, y1) = self.getRandomLegalPosition()
        #     self.agentPositions.append((1, (x1, y1)))
...
def getLayout(name, back=2):
    ...
    if name.endswith('.lay'):
        layout = tryToLoad(os.getcwd() + '/game/pacman/layouts/' + name)
        print(os.getcwd() + '/game/pacman/layouts/' + name)
        if layout == None:
            layout = tryToLoad(name)
    else:
        layout = tryToLoad(os.getcwd() + '/game/pacman/' + 'layouts/' + name + '.lay')
        print(os.getcwd() + '/game/pacman/' + 'layouts/' + name + '.lay')
        if layout == None:
