...
def parse_args():
    ...
    parser.add_argument("--learning_rate_c", type=float, default=1e-2, help="learning rate for Adam optimizer")
    parser.add_argument("--learning_rate_a", type=float, default=1e-2, help="learning rate for Adam optimizer")
